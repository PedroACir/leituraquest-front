...
interface TextInputProps {
  ...
  value: string; // Adicionamos o valor
  onChange: (e: React.ChangeEvent<HTMLInputElement>) => void; // Adicionamos o onChange
}
  ...
  return (
    <div className="w-full">
      ...
      <div className="relative">
        <input
          type="text"
          name={name} // Passando a propriedade name
          placeholder={placeholder}
          value={value} // Passando o valor
          onChange={onChange} // Passando o evento onChange
